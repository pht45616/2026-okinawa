            ...
            plans: [
                {
                    id: "planA",
                    name: "方案 A：街頭跑跑卡丁車體驗",
                    title: "懸崖神社散策 ✕ 沖繩飯糰 ✕ 跑跑卡丁車飆風 ✕ 琉星居酒屋",
                    badge: "需帶台灣駕照正本+日文譯本",
                    color: "#38bdf8",
                    googleMapsUrl: "https://www.google.com/maps/dir/Hotel+Collective+Naha/波上宮/ポークたまごおにぎり本店+牧志市場店/東町7-1/琉球海鮮酒場+琉星/Hotel+Collective+Naha",
                    rainPlan: "若下大雨卡丁車取消，下午改前往【沖繩縣立博物館・美術館 (OkiMu)】或國際通室內拱廊商街採買。",
                    stops: [
                        {
                            id: 1,
                            time: "06:30",
                        ...
                        },
                        {
                            ...
                            category: "spot",
                            categoryLabel: "海景參拜",
                            desc: "漫步至懸崖上的波上宮參拜祈福、抽籤，隨後走至一旁的波之上海灘踏浪放空，清晨人少舒服。",
                            lat: 26.2207,
                            lng: 127.6713,
                            stay: "60分",
                            tips: "避開午後豔陽，早晨參拜最為清幽愜意",
                            mapsUrl: "https://www.google.com/maps/search/?api=1&query=Naminoue+Shrine"
                        },
                        {
                            id: 3,
                            time: "11:30",
                            name: "第一牧志公設市場 ＆ ポーたま (沖繩飯糰)",
                            shortName: "牧志飯糰 🍙",
                            category: "food",
                            categoryLabel: "午餐輕食",
                            desc: "回國際通漫步至牧志市場，品嚐現點現做的炸蝦明太子或苦瓜玉子燒飯糰。周邊平和通可悠閒穿梭探店。",
                            lat: 26.2145,
                            lng: 127.6888,
                            stay: "60分",
                            tips: "沖繩靈魂美食，份量剛剛好不造成腸胃負擔",
                        ...
                        },
                        {
                            ...
                            category: "spot",
                            categoryLabel: "文青散策",
                            desc: "漫步於綠蔭石板陶藝老街，挑選特色陶器，或找間質感冷氣咖啡廳放鬆喝冰滴咖啡。",
                            lat: 26.2135,
                            lng: 127.6912,
                            stay: "90分",
                            tips: "步調慢活，為下午的卡丁車飆風儲備精神",
                            mapsUrl: "https://www.google.com/maps/search/?api=1&query=Yachimun+Street"
                        },
                        {
                            id: 5,
                            time: "15:45",
                            ...
                            category: "activity",
                            categoryLabel: "重點活動",
                            desc: "15:45 前抵達集合點（那霸市東町7-1）。換上特色服裝開上真實市區道路，途經那霸港、跨海大橋前往瀨長島停留拍照後折返。",
                            lat: 26.2125,
                            lng: 127.6755,
                            stay: "135分",
                            tips: "🔥 務必隨身攜帶台灣駕照正本＋日文譯本正本與護照！提早15分報到",
                            mapsUrl: "https://www.google.com/maps/search/?api=1&query=26.2125,127.6755"
                        },
                        {
                            id: 6,
                            time: "18:30",
                            ...
                            category: "food",
                            categoryLabel: "晚餐居酒屋",
                            desc: "結束刺激好玩的卡丁車後，步行回國際通/久茂地享用在地現流生魚片、沖繩炒苦瓜與生啤酒。",
                            lat: 26.2168,
                            lng: 127.6834,
                            stay: "90分",
                            tips: "運動與吹風後的大滿足居酒屋",
                        ...
                        },
                        {
                            ...
                            category: "hotel",
                            categoryLabel: "夜宿飯店",
                            desc: "步行返回嘉新酒店 (Hotel Collective)，結束充實刺激的一天。",
                            lat: 26.2162,
                            lng: 127.6872,
                            stay: "過夜",
                            tips: "回房好好泡澡休息",
        ...
        },
        {
            ...
            stops: [
                ...
                },
                {
                    id: 6,
                    time: "18:30",
                    name: "沖縄料理 しまぶた屋 恩納本店 (蒸籠阿古豬)",
                    shortName: "しまぶた屋 🐷",
                    category: "food",
                    categoryLabel: "阿古豬晚餐",
                    desc: "晚餐：知名杉木蒸籠料理！利用蒸氣鎖住阿古豬肉脂甘甜與島野菜脆度，無油膩感。務必提早預約 18:30 席位！",
                    lat: 26.4521,
                    lng: 127.8189,
                    stay: "90分",
                    tips: "🔥 務必預約！⚠️ 58號公路傍晚往恩納極易塞車，建議 18:00 前自飯店出發",
                    mapsUrl: "https://www.google.com/maps/search/?api=1&query=Shimabutaya+Onna"
                },
                {
                    id: 7,
                    time: "20:30",
        ...
        },
        {
            ...
            stops: [
                ...
                },
                {
                    ...
                    category: "food",
                    categoryLabel: "海景午餐",
                    desc: "午餐：位於美麗海旁 Ala MAHAINA 商場內，挑高落地窗遠眺瀨底島海景！品嚐現撈生魚片定食與海膽鮭魚卵丼（備案：岸本食堂）。",
                    lat: 26.6895,
                    lng: 127.8742,
                    stay: "75分",
                    tips: "環境寬敞明亮，景觀優美且停車極方便",
                    mapsUrl: "https://www.google.com/maps/search/?api=1&query=海人料理海邦丸"
                },
                {
                    id: 4,
                    time: "14:30",
            ...
            plans: [
                {
                    ...
                    stops: [
                        ...
                        },
                        {
                            id: 3,
                            time: "10:40",
                            name: "港川外人住宅區 (oHacorté 港川本店)",
                            shortName: "港川外人住宅 🏘️",
                            category: "shopping",
                            categoryLabel: "文青甜點",
                            desc: "舊美軍宿舍改建質感聚落，品嚐 oHacorté 招牌水果塔；精準採買「旅するタルト砂餅」與「檸檬蛋糕」伴手禮禮盒。",
                            lat: 26.2625,
                            lng: 127.7153,
                            stay: "70分",
                            tips: "💡 完美整合 oHacorté，既能享用甜點又能直接買齊高品質伴手禮！",
                            mapsUrl: "https://www.google.com/maps/search/?api=1&query=oHacorte+Minatogawa"
                        },
                        {
                            id: 4,
                            time: "12:00",
                            name: "午後放空 ＆ 機場還車（瀨長島或糸滿魚市場）",
                            shortName: "瀨長島 / 糸滿 ✈️",
                            category: "spot",
                            categoryLabel: "午後放空",
                            desc: "午後放空二擇一：原案【瀨長島 Umikaji Terrace】白色階梯看海吃點心；或備案【糸滿魚市場 ＆ iias 沖繩豐崎】吃海鮮與補齊免稅土產。13:30 前往營業所還車。",
                            lat: 26.1751,
                            lng: 127.6433,
                            stay: "75分",
                            tips: "💡 完美整合 Day 2 卡丁車心得：若想再看飛機選瀨長島，若想吃海鮮或大型商場採買選糸滿與 iias！",
